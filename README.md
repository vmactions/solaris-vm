...
>
> Just describe what you want in plain language, e.g. *"run my tests on Solaris"* or *"check that my project builds on Solaris aarch64"*, and the agent generates a correct, ready-to-commit `test.yml`. It will:
>
